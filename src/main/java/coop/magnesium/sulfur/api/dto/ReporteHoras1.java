...
public class ReporteHoras1 {
    ...
    public ReporteHoras1() {
    }

    public ReporteHoras1(BigDecimal cantidadHoras, BigDecimal cantidadHorasEstimadas, BigDecimal precioEstimado, BigDecimal precioTotal, Proyecto proyecto, TipoTarea tipoTarea, Cargo cargo) {
